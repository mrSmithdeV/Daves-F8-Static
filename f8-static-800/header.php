...
<a href="<?php echo get_option('home'); ?>/" title="<?php bloginfo('name'); ?> - <?php bloginfo('description'); ?>"><img src="http://www.davidpaulsmith.co.uk/wp-content/uploads/2011/01/nickwebb.gif" /></a>  
  </div>
...
<h4><span class="contact"><?php if ( $options['phone'] != '' ) { ?><?php echo $options['phone']; ?><br /><?php } if ( $options['email'] != '' ) { ?><a href="mailto:<?php echo $options['email']; ?>"><?php echo $options['email']; ?></a><?php } ?></span></h4>
</div>
<!--div>
<?php
