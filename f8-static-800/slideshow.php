...
<?php query_posts('showposts=5&cat='.$slideshow_cats.''); $i=0; ?>
	...
	<?php while (have_posts()) : the_post(); $i++; ?>
			<div class="slide"><?php get_the_image( array( 'custom_key' => array( 'slideshow' ), 'default_size' => '950x425', 'width' => '950', 'height' => '425', 'image_class' => '', 'default_image' => 'wp-content/themes/f8-static/images/default_header.jpg' ) ); ?></div>
    ...
    <div id="slideshow-posts">
        <?php while ($slideshow_query->have_posts() && $i<=5) : $slideshow_query->the_post(); $do_not_duplicate = $post->ID; ?>
			...
			<div class="slide">
				...
				<?php get_the_image( array( 'custom_key' => array( 'slideshow' ), 'default_size' => '950x425', 'width' => '950', 'height' => '425', 'image_class' => '', 'default_image' => 'wp-content/themes/f8-static/images/default_header.jpg' ) ); ?>
				</div>
