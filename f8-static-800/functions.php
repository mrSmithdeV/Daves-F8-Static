...
if ( function_exists( 'add_theme_support' ) ) { 
	...
	add_image_size( '800x425', 800, 425, true ); // 950x425 image size
	add_image_size( '800', 800, 9999 ); // 950 image size
}
...
function f8_theme_nav() {
	if ( function_exists( 'wp_nav_menu' ) )
		wp_nav_menu( 'sort_column=menu_order&container_class=sf-menu clearfix&menu_location=main-menu&fallback_cb=f8_nav_fallback' );
	else
		f8_nav_fallback();
}
